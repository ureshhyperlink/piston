...
const styles = StyleSheet.create({
    ...
    buttonContainer:{
        paddingStart: MATRICS.dimn24px,
        paddingEnd: MATRICS.dimn24px,
        paddingTop: MATRICS.dimn8px,
        paddingBottom: MATRICS.dimn8px,
        backgroundColor: COLOR.color.COLOR_SECONDARY,
        borderRadius: MATRICS.dimn24px
    }
});
