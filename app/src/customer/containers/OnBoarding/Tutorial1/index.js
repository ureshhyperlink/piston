...
class Tutorial1 extends React.Component {
    ...
    handlePress = (val) => {
        if (val == "skip") {
            ...
            this.props.navigation.push('Tutorial2')
        }
    }
        ...
        return (
            <View style={styles.container}>
                <View style={styles.topContainer}>
                    <Text style={COMMON.text24pxSteelBold}>{translations.tutorial_title_1}</Text>
                </View>
                <View style={styles.middleContainer}>
                    <View style={styles.imageContainer}>
                        <Image source={IMAGES.images.tutorial_1} />
                    </View>
                    <Text style={[COMMON.text16pxBlack, { padding: MATRICS.dimn12px, textAlign: 'center' }]}>{translations.tutorial_msg_1}</Text>
